...
import { Button, Card, Divider, Input, Typography, Alert, Badge, List, Drawer, notification } from 'antd';
import {
    VideoCameraOutlined,
    AudioOutlined,
    WarningOutlined,
...
const TestInterface: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const resetIdleTimer = () => {
            ...
            idleTimerRef.current = setTimeout(() => {
                alert('You were idle for 10 minutes. The test is now terminated.')
                window.location.href = '/'
            }, 10 * 60 * 1000);;
        };
                ...
                setTabSwitchCount(prev => {
                    ...
                    if (newCount <= 3) {
                        notification.warning({
                            ...
                            description: `You have switched tabs ${newCount} time(s). You are allowed only 3.`,
                            placement: 'topRight',
                            duration: 5,
                            style: {
                                width: 400,
                    ...
                    if (newCount > 3) {
                        ...
                        notification.error({
                            ...
                            description: 'You have exceeded the maximum allowed tab switches.',
                            placement: 'topRight',
                            duration: 3
                        });

                        // Navigate to termination page after a short delay
                        setTimeout(() => {
    ...
    }, [testStarted, navigate, stopDetection, stopMonitoring, isDetecting, isMonitoring]);
                ...
                <Card style={{ width: '500px', textAlign: 'center' }}>
                    ...
                    <List
                        ...
                        dataSource={[
                            ...
                            'Sitting idle for 10 minutes will lead to test termination'
                        ]}
                        renderItem={item => (
    ...
    return (
        <div ref={testContainerRef} style={{ display: 'flex', minHeight: '100vh', position: 'relative' }}>
                ...
                >
                    ...
                    <div style={{ marginTop: '10px', fontSize: '12px' }}>
                        <Text type="secondary">
                            ...
                            Tab Switches: <span style={{
                                color: tabSwitchCount > 2 ? '#ff4d4f' : tabSwitchCount > 0 ? '#faad14' : 'inherit',
                                fontWeight: tabSwitchCount > 0 ? 'bold' : 'normal'
                            }}>{tabSwitchCount}/3</span><br />
            ...
            >
                <List.Item style={{ textAlign: 'left' }}>
                    <Text>• Sitting idle for 10 minutes will lead to test termination</Text>
                </List.Item>
                <List
